            ...
            <div class="container pb-4">
                ...
                <tr> 
                    ...
                    <tr>
                                ...
                                <h4 class="alert-heading">Actualización datos en el Control de Expedientes RRHH</h4>
                                <p>Mi estimado(a),usted no puede realizar la Actualización de datos, ya que su registro de ingreso RRHH no ha sido incorporado.</p>
                                <hr>
                                ...
                                <div class="frameContenedor" style="margin:5px;" align="right">                      
                                    <a class='btn btn-secondary' href="{{URL::route('buscarfuncionario')}}">Regresar</a> 
                                </div>
                    @endif
