...
class VacacionesController extends Controller
{
    ...
    public function funcionarios()
    {
      ...
      $nacionalidades= Nacionalidad::All();
        ...
        $datos_funcionario  =   Funcionario::select('funcionario.id as rrhh.funcionario.id',
        'rrhh.funcionario.*','persona.*','rrhh.funcionario.cargo as cargo','rrhh.funcionario.id_oficina_administrativa'     ,
        ...
        'ent.descripcion as ent_domi','municipio.nombre as muni_domi','parroquia.nombre as parr_domi','rrhh.funcionario.id_tipo_funcionario as tipo_trabajador') 
     ...
     $vacaciones_solicitudes= Solicitud_vacaciones::select('vacaciones.solicitud_vacaciones.*')->join ('rrhh.funcionario', 'rrhh.funcionario.id','=','vacaciones.solicitud_vacaciones.funcionario_id') 
    ...
    public function create(Request $request,$cedula)
    {
      ...
      //  dd($fecha_ingreso_vac,  $annos_solicitud);
        ...
        $datos_funcionario= Funcionario::select('rrhh.funcionario.id as funcionario_id','tipo_trabajador.id as id_tipo_trabajador',
        'rrhh.funcionario.*','persona.*','rrhh.funcionario.cargo as cargo','rrhh.funcionario.id_oficina_administrativa'     ,
        'estado_civil.descripcion as est_civil','entidad.descripcion as estado_nac',
        'tipo_trabajador.descripcion as trabajador','ubic_administrativa.descripcion as administrativa',
        'ent.descripcion as ent_domi','municipio.nombre as muni_domi','parroquia.nombre as parr_domi','rrhh.funcionario.id_tipo_funcionario as tipo_trabajador') 
    ...
    public function ver_pendientes(Request $request)
    {
       ...
       // dd($request);
        ...
        $pendientes= Vacaciones_pendientes::select('vacaciones.vacaciones_pendientes.*','rrhh.funcionario.*','persona.*','rrhh.funcionario.cargo as cargo','rrhh.funcionario.id_oficina_administrativa'     ,
        'estado_civil.descripcion as est_civil','entidad.descripcion as estado_nac',
        'tipo_trabajador.descripcion as trabajador','ubic_administrativa.descripcion as administrativa',
        'ent.descripcion as ent_domi','municipio.nombre as muni_domi','parroquia.nombre as parr_domi','rrhh.funcionario.id_tipo_funcionario as tipo_trabajador')     
        ->join ('rrhh.funcionario', 'funcionario.id','=','vacaciones.vacaciones_pendientes.funcionario_id')   
        ->join ('persona', 'persona.id','=','rrhh.funcionario.persona_id')    
        ->join('estado_civil','estado_civil.id','=','persona.id_estado_civil')  
        ->join('entidad','entidad.id','=','persona.estado_nac') 
        ->JOIN('tipo_trabajador','tipo_trabajador.id','rrhh.funcionario.id_tipo_funcionario')      
    ...
    public function ver_aprobadas(Request $request)
    {
       ...
       $vacaciones_solicitudes= Solicitud_vacaciones::select('vacaciones.solicitud_vacaciones.*','persona.*','rrhh.funcionario.*')
       ->join ('rrhh.funcionario', 'funcionario.id','=','vacaciones.solicitud_vacaciones.funcionario_id') 
       ->join ('persona', 'persona.id','=','funcionario.persona_id')    
       ->where('vacaciones.solicitud_vacaciones.revisado','=',1)
       ->where('vacaciones.solicitud_vacaciones.aprobado_coordinador','=',1)
     
       ->where('rrhh.funcionario.id_oficina_administrativa','=',$funcionario->id_oficina_administrativa)
       ->get();     
    ...
    public function ver_pendientes_aprobar(Request $request)
    {
       ...
       // var_dump($datos_funcionario) ;
       $vacaciones_solicitudes= Solicitud_vacaciones::select('vacaciones.solicitud_vacaciones.*','vacaciones.solicitud_vacaciones.id as id_solicitud','persona.*','rrhh.funcionario.*')
       ->join ('rrhh.funcionario', 'funcionario.id','=','vacaciones.solicitud_vacaciones.funcionario_id') 
       ->join ('persona', 'persona.id','=','funcionario.persona_id')    
       ->where('vacaciones.solicitud_vacaciones.revisado','=',0)
       ->where('rrhh.funcionario.id_oficina_administrativa','=',$funcionario->id_oficina_administrativa)->get();
    ...
    public function ver_aprobadas_director(Request $request)
    {
       ...
       $vacaciones_solicitudes= Solicitud_vacaciones::select('vacaciones.solicitud_vacaciones.*','vacaciones.solicitud_vacaciones.id as id_solicitud','persona.*','rrhh.funcionario.*')
       ->join ('rrhh.funcionario', 'rrhh.funcionario.id','=','vacaciones.solicitud_vacaciones.funcionario_id') 
       ->join ('persona', 'persona.id','=','funcionario.persona_id')    
       ->where('vacaciones.solicitud_vacaciones.revisado','=',1)
       ->where('vacaciones.solicitud_vacaciones.aprobado_coordinador','=',1)
       ->where('vacaciones.solicitud_vacaciones.aprobado_director','=',1)
    ...
    public function aprobacion(Request $request,$id)
    {
        ...
        $cedula=Auth::user()->cedula;
        $solicitudes= Solicitud_vacaciones::select('vacaciones.solicitud_vacaciones.*','vacaciones.solicitud_vacaciones.id as id_solicitud', 
         'rrhh.funcionario.*','persona.*','rrhh.funcionario.cargo as cargo','rrhh.funcionario.id_oficina_administrativa'     ,
        'estado_civil.descripcion as est_civil','entidad.descripcion as estado_nac',
        'tipo_trabajador.descripcion as trabajador','ubic_administrativa.descripcion as administrativa',
